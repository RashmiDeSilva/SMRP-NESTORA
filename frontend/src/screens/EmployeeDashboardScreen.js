      ...
      >
        <View style={styles.mockupImageWrapper}>
          {booking.boarding?.coverImage ? (
            ...
            <View style={[styles.mockupImage, { backgroundColor: '#E0F2F1', justifyContent: 'center', alignItems: 'center' }]}>
              <Ionicons name="home-outline" size={24} color="#005B66" />
            </View>
          )}
        </View>
      ...
      <View style={styles.propertyImageWrapper}>
        {item.coverImage ? (
          ...
          <View style={styles.propertyImagePlaceholder}>
            <Ionicons name="home-outline" size={32} color="#005B66" />
          </View>
        )}
      </View>
  ...
  return (
    <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
              <SafeAreaView>
                ...
                <View style={styles.greetingContainer}>
                  ...
                  <Text style={styles.subGreetingText}>Find the best stay near your workplace</Text>
                </View>
                ...
                <View style={styles.searchBar}>
                  ...
                  <TouchableOpacity style={styles.searchButton}>
                    <Feather name="search" size={16} color="#005B66" />
                  </TouchableOpacity>
                </View>
              </SafeAreaView>
            </View>
      ...
      <View style={styles.bottomTabBar}>
        ...
        >
          <Feather name="home" size={22} color={activeFilter === 'all' ? '#005B66' : '#94A3B8'} />
        ...
        >
          <Feather name="heart" size={22} color={activeFilter === 'saved' ? '#005B66' : '#94A3B8'} />
        ...
        >
          <Feather name="calendar" size={22} color={activeFilter === 'bookings' ? '#005B66' : '#94A3B8'} />
        ...
        <View style={styles.menuOverlay}>
          ...
          <View style={styles.menuContent}>
            <View style={styles.menuHeader}>
              ...
              <Text style={[styles.menuUserName, {color: '#005B66'}]}>{firstName || 'shasha!'}</Text>
            </View>
