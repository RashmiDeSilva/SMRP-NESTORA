      ...
      >
        <View style={styles.mockupImageWrapper}>
          {booking.boarding?.coverImage ? (
            ...
            <View style={[styles.mockupImage, { backgroundColor: '#CCFBF1', justifyContent: 'center', alignItems: 'center' }]}>
      ...
      <View style={styles.propertyImageWrapper}>
        {item.coverImage ? (
          ...
          <View style={styles.propertyImagePlaceholder}>
            <Ionicons name="home-outline" size={32} color="#0D9488" />
          </View>
        )}
      </View>
  ...
  return (
    <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
              <SafeAreaView>
                ...
                <View style={styles.greetingContainer}>
                  ...
                  <Text style={styles.subGreetingText}>Find boarding near your internship</Text>
                </View>
      ...
      <View style={styles.bottomTabBar}>
        ...
        >
          <Feather name="home" size={22} color={activeFilter === 'all' ? '#0D9488' : '#94A3B8'} />
        ...
        >
          <Feather name="heart" size={22} color={activeFilter === 'saved' ? '#0D9488' : '#94A3B8'} />
        ...
        >
          <Feather name="calendar" size={22} color={activeFilter === 'bookings' ? '#0D9488' : '#94A3B8'} />
        ...
        <View style={styles.menuOverlay}>
          ...
          <View style={styles.menuContent}>
            <View style={styles.menuHeader}>
              ...
              <Text style={[styles.menuUserName, {color: '#0D9488'}]}>{firstName || 'shasha!'}</Text>
            </View>
